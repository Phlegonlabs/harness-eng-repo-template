...
export function renderReadyProgressDoc(): string {
	return [
		...
		"- Harness alignment follow-up is tracked in `docs/execution-plans/harness-engineering-alignment.md` while the template runtime safeguards are being tightened.",
		"- Harness alignment safeguards are recorded in `docs/decisions/004-harness-alignment-safeguards.md`.",
