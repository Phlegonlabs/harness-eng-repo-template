...
export function renderReadyProgressDoc(): string {
	return [
		...
		"| Task loop | Ready | Use `harness:orchestrate` + `harness:evaluate --all` for contract-driven execution |",
		"",
		"---",
		"",
		"## Milestones",
